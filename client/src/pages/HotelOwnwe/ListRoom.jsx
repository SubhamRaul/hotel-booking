...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title font='outfit' title='Room Listings' subTitle='View,edit,manage all listed rooms.' />
                  ...
                  <tr key={index}>
                    ...
                    <td className='py-3 px-4 text-red-500 border-t border-gray-300 text-center'>
                      <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                        ...
                        <div className="w-12 h-7 bg-slate-300 peer-checked:bg-blue-600 transition-colors duration-300 rounded-2xl "></div>
